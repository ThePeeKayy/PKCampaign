...
const posts = [
  ...
  const house = [
    {
      id: 1,
      title: 'Source of motivation to keep the BAD blues out',
      imageUrl:
        'https://cdn1.iconfinder.com/data/icons/cute-emoji-smiles-with-gradient/83/Awkward_Emoji_Emoticon_Happy_Simle-256.png',
    },
    {
        id: 2,
        title: 'Structures involvement in the community, or just a channel to yap :)',
        imageUrl:
          'https://cdn2.iconfinder.com/data/icons/flat-icons-19/512/Cup.png',
        
      },
      {
        id: 3,
        title: 'Conglomerate of interesting opinions and stories',
        imageUrl:
          'https://cdn4.iconfinder.com/data/icons/small-n-flat/24/book-256.png',
      },
  ]
const MainContent = () => {
  return (
    <div>
        <div className='flex justify-evenly flex-row gap-x-10 mt-[80px] mx-8 my-[200px]'>
            <Image src={img2} className='rounded-full lg:block hidden' height={330} width={350}/>
            
            <div className='flex flex-col items-center gap-y-4'>
                <h1 className="max-w-2xl text-5xl font-bold tracking-tight text-gray-900 lg:col-span-2 xl:col-auto">
                    Who I am
                </h1>
                <Image src={img2} className='rounded-full lg:hidden block mt-8' height={165} width={170}/>
                <div className="mt-[40px] max-w-xl xl:col-end-1 xl:row-start-1 ring-[2px] ring-gray-100 p-10 rounded-xl shadow-lg">
                    ...
                    <p className="text-lg leading-8 text-gray-600">
                    • Im very good at driving...my Wi-Fi nuts by streaming 20 tabs at once
                    </p>
                </div>
            </div>
        </div>
